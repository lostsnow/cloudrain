...
const AMBIGUOUS_WIDE = [
  [0x2190, 0x21ff],
  [0x223d, 0x223d], [0x2248, 0x2248], [0x224c, 0x224c],
  [0x2460, 0x24fe],
  [0x2500, 0x2573], [0x2580, 0x2613],
];
...
export class UnicodeV11Ambiguous {
  constructor() {
    this.version = '11-ambiguous';
    if (!table) {
  ...
  wcwidth(num) {
    if (num < 32) return 0;
    if (num < 127) return 1;
    if (bisearch(num, AMBIGUOUS_WIDE)) return 2;
